...
public class RandomActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Setup adapters for the spinners to list different graphic choices //
		...
		// Setup adapter for the spinner to list different algorithm choices
		Spinner generator = (Spinner) findViewById( R.id.spinalgorithm );
	...
	public void onClick(View v) {
		...
		case R.id.btngenerate:
			// Get all of the user inputed information and send it to the Navigator Activity through an intent //
