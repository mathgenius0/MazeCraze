...
public class CreatorActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		switch ( v.getId() ) {
		case R.id.btnreturn:
			// Create dialog warning that their changes will be lost //
			AlertDialog.Builder alertDialog = new AlertDialog.Builder( this );
			alertDialog.setTitle( "Warning" );
			alertDialog
					.setMessage( "Are you sure you would like to return to the main menu? Your unsaved changes will be lost." );
			alertDialog.setPositiveButton( "Yes", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
					// Return to main menu if they say Yes //
			...
			break;
		case R.id.btnsave:
			// Save current grid to cloudmine //
